...
public class ACTIONS {
	...
	final public static String FIRST_VISIT_INFO_START = "first_visit_info_start";	//tell client that the actions of the first-visit-info start here
	...
	final public static String OPEN_FRAMES_VIEW = "open_frames_view";		//tell client to open a frames view, parameters: type (input, suggestion, ...)
